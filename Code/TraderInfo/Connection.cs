...
namespace TraderInfo.Repository
{
    public partial class AzureDBRepository<Trade> : IAzureDBRepository<Trade> where Trade : class
    {
        ...
        private readonly string CollectionId = "Trader";
        ...
        //    if (typeof(Trade) == typeof(ProsumerTradesOffer)) { CollectionId = "ProsumerTradesOffers"; }
        //    if (typeof(Trade) == typeof(ProsumerTradesSale)) { CollectionId = "ProsumerTradesSales"; }
        //}
    }
}
